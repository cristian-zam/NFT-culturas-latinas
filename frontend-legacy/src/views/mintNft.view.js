...
function LightHeroE(props) {
  ...
  const goNativoNftV2 = async () => {
    window.open('https://www.nativonft.app/');  
  }
  ...
  return (
    ...
    //   <Modal {...modal} />
    // </section>
    <div class="pt-6 text-center w-3/5 mx-auto mt-5 space-y-4 bg-gray-100 rounded">
      <blockquote>
        <p class="text-lg font-semibold">
          "Ya existe una nueva versión de Nativo NFT, da clic al siguiente botón para acceder"
        </p>
      </blockquote>
      <figcaption class="font-medium">
        <div class="text-cyan-600">
          <button className={` mt-12 w-full text-white bg-${props.theme}-500 border-0 py-2 px-6 focus:outline-none hover:bg-${props.theme}-600 rounded text-lg`} onClick={goNativoNftV2}>
                Nativo NFT V2
            </button>
        </div>
      </figcaption>
